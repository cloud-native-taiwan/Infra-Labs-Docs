...
| VLAN | 名稱 | 子網 | 閘道 / SVI | 用途 | Trunk 所在 |
|------|------|------|------------|------|------------|
| 3000 | vlan-nat | 192.168.0.0/24 | 192.168.0.254 (NFX250 JunOS ge-1/0/0.1) | 帶內管理 / NAT 出口 | NFX250 ge-0/0/0-4, sxe-0/0/0 |
...
| 主機 | VLAN 3000 (mgmt) | VLAN 1007 (IPMI) | VLAN 1113 (API) | VLAN 1114 (Ceph pub) | VLAN 1115 (Ceph priv) | Bond / NIC |
|------|---------------|-------------------|-----------------|----------------------|-----------------------|------------|
