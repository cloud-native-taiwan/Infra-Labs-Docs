...
| 埠 | 名稱 | 模式 | VLAN | 連接至 |
|----|------|------|------|--------|
| ge-0/0/0 | deploy01 | trunk | 3000 (native), 2116, 1007 | 部署主機 VM |
| ge-0/0/1 | openstack01 | trunk | 3000 (native), 2116, 1007 | openstack01 mgmt / IPMI |
| ge-0/0/2 | openstack02 | trunk | 3000 (native), 2116, 1007 | openstack02 mgmt / IPMI |
| ge-0/0/3 | openstack03 | trunk | 3000 (native), 2116, 1007 | （未使用，openstack03 已除役） |
| ge-0/0/4 - ge-0/0/7 | - | access | 3000 | 未使用 / 保留 |

**10GbE SFP+ 上行鏈路：**

| 埠 | 模式 | VLAN | 連接至 |
|----|------|------|--------|
| xe-0/0/12 | trunk | 1113, 1007, 3000, 2116 | Arista Et27/2 |
| xe-0/0/13 | - | - | 未使用 |
