...
|------|----------|------|----------|------|---------|----------|
| NFX250 | fw1 | Juniper NFX250 | Junos 22.4R1.10 | 邊界路由器 | 192.168.7.1 (ge-1/0/0.3), 192.168.7.11 (fxp0) | NAT、VM 託管、WireGuard |
...
| 埠 | 名稱 | 模式 | VLAN | 連接至 |
|----|------|------|------|--------|
| ge-0/0/0 | openstack01-mgmt | trunk | 3000 (native), 2116, 1007 | openstack01 mgmt |
| ge-0/0/1 | openstack02-mgmt | trunk | 3000 (native), 2116, 1007 | openstack02 mgmt |
| ge-0/0/2 | openstack05-mgmt | trunk | 3000 (native), 2116, 1007 | openstack05 mgmt |
| ge-0/0/3 | openstack04-mgmt | trunk | 3000 (native), 2116, 1007 | openstack04 mgmt |
| ge-0/0/4 | openstack06-mgmt | trunk | 3000 (native), 2116, 1007 | openstack06 mgmt |
...
- **Po1001** 為連接 Apernet (AS38008) 的上游鏈路。以 2x100GbE 提供 200 Gbps 聚合轉接頻寬。承載 VLAN 1（預設）及 1000，供 BGP 對等互聯與管理使用。
