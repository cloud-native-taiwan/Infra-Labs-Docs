...
單一 NFX250 設備（主機名稱 `fw1`）位於網路邊緣。其具備 8 個 RJ-45 埠（ge-0/0/0 至 ge-0/0/7）用於伺服器管理連線及 IPMI，另有 10GbE SFP+ 上行鏈路連接至 Arista。該設備託管一台管理虛擬機，提供：
- VLAN 1 的預設閘道 (192.168.0.254)
- 管理主機的 NAT 出站網際網路存取
- WireGuard VPN 端點 (192.168.118.1/24 on wg0)
- 公用 IPv4 (103.122.117.253) 及 IPv6 (2403:8ec0::d207:caff:fecc:e497/64) 連線
...
graph TB
    ...
    subgraph Boundary["Boundary Plane"]
        ...
        NFXVM["NFX250 VM<br/>NAT / VPN / Gateway<br/>192.168.0.254"]
    end
